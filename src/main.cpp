...
uint256 hashGenesisBlock("0x372f05912b40b5a9d064e8e61732d411cf502ba57fe95521b2226b13fc3a0f2b");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // VinaCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "VinaCoin Signed Message:\n";
...
{
    // VinaCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // VinaCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // VinaCoin: 3.5 days
static const int64 nTargetSpacing = 150; // VinaCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // VinaCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // VinaCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // VinaCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd83f32b86f9c295622d9207f852c2d58b6723328833584a23a69433e618a4e41");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("c73334feccfc65db00b66036138403a1eb9688481bf1ab53bcb0991340a200de538ee7a51efcf38825e20419e2d8280b804dbc55c4585243b7171f638afff941f3") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1499984370;
        block.nBits    = 504365644;
        block.nNonce   = 2605854396;

        if (fTestNet)
        {
            block.nTime    = 1499984370;
            block.nNonce   = 3548764726;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x9473f232f8a71026252608f409002f3076bf274dc8d3c860b250b15f22759b7b"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // VinaCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("VinaCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("VinaCoinMiner : ProcessBlock, block not accepted");
    }
